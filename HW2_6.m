...
error1
 set(gca,'fontsize',20)
figure(2)
semilogy(errorvect,'r','Linewidth',2)
 title('Log plot of error vs number of V-cycles (n=64)','fontsize',20)
  set(gca,'fontsize',18)
figure(3)
plot(x,y,'rx-', x, true,'Linewidth',2); 
title('Plot of last V-cycle result $d_{xx} = \delta $(n=64)','fontsize',20,'Interpreter','latex'); 
hold on; 
 set(gca,'fontsize',20)